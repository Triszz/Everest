 ...
 * Voucher Routes
 * --------------------------------------------------------------
 * Mount trong app.ts ở prefix `/api/vouchers` và `/api/customer/search`.
 * Routes:
 ...
 *
 * Lưu ý: `/search/partners` phải đứng TRƯỚC `/:id` để Express không nhầm "search" thành param `:id`.
 *
 * Review endpoints mount ở reviews.routes.ts
 * (prefix `/api/customer/vouchers`) để giữ backward-compat.
 */
...
/** GET /api/vouchers/:voucherId/reviews — Review của voucher (public) */
