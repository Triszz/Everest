...
const VOUCHER_TEMPLATES: Record<
  number,
  Array<Omit<Parameters<typeof prisma.voucher.create>[0], "data"> & { data: Record<string, unknown> }>
> = {
  // 1: Ăn uống
  1: [
    {
      data: {
        title: "Voucher Phượng Hoàng – Giảm 20%",
        description: "Giảm 20% cho tất cả món ăn tại nhà hàng Phượng Hoàng. Áp dụng cuối tuần và ngày lễ.",
        originalPrice: new Prisma.Decimal(500000),
    ...
    },
    {
      data: {
        ...
        description: "Ưu đãi 30% cho món đặc sản miền Trung. Không áp dụng đồ uống.",
        originalPrice: new Prisma.Decimal(800000),
        salePrice: new Prisma.Decimal(560000),
    ...
    {
      data: {
        title: "Combo Quán Ăn Ngon – Giảm 25%",
        description: "Giảm 25% toàn bill cho 2 người trở lên. Không áp dụng cho đơn dưới 200.000đ.",
        originalPrice: new Prisma.Decimal(350000),
        salePrice: new Prisma.Decimal(262000),
  ...
  2: [
    {
      data: {
        title: "Voucher Coffee House – Mua 1 Tặng 1",
        description: "Mua 1 tặng 1 trà sữa bất kỳ size nào. Áp dụng cả Online và Offline.",
        originalPrice: new Prisma.Decimal(55000),
    ...
    {
      data: {
        title: "Highlands Coffee – Giảm 15%",
        description: "Giảm 15% cho tất cả đồ uống tại Highlands Coffee. Áp dụng từ thứ 2 đến thứ 6.",
        originalPrice: new Prisma.Decimal(70000),
        salePrice: new Prisma.Decimal(59500),
  ...
  3: [
    {
      data: {
        title: "Lotteria – Combo Burger + Khoai Tây",
        description: "Combo gồm 1 Burger gà + 1 Khoai tây size M + 1 Nước. Tiết kiệm đến 25%.",
        originalPrice: new Prisma.Decimal(95000),
        salePrice: new Prisma.Decimal(72000),
    ...
    {
      data: {
        title: "KFC – Ưu Đãi Thứ 3 – Giảm 30%",
        description: "Giảm 30% cho đơn từ 150.000đ trở lên vào thứ 3 hàng tuần.",
        originalPrice: new Prisma.Decimal(120000),
        salePrice: new Prisma.Decimal(84000),
  ...
  4: [
    {
      data: {
        title: "Gong Cha – Mua 3 Tặng 1",
        description: "Mua 3 ly trà sữa bất kỳ, tặng 1 ly cùng loại. Không áp dụng topping thêm.",
        originalPrice: new Prisma.Decimal(70000),
        salePrice: new Prisma.Decimal(52500),
        imageUrl: "https://images.unsplash.com/photo-1558857563-b371033873b8?w=800&h=600&fit=crop",
        expiryDays: 14,
        totalQuantity: 600,
    ...
    {
      data: {
        title: "Koi Thé – Giảm 20%",
        description: "Giảm 20% cho tất cả đồ uống. Áp dụng cho khách hàng mới vào ngày thứ 2.",
        originalPrice: new Prisma.Decimal(60000),
        salePrice: new Prisma.Decimal(48000),
  ...
  5: [
    {
      data: {
        title: "Pizza Hut – Combo Gia Đình",
        description: "1 Pizza size M + 1 Mì Ý + 2 Nước giải khát. Đủ cho 3-4 người.",
        originalPrice: new Prisma.Decimal(450000),
        salePrice: new Prisma.Decimal(359000),
    ...
    {
      data: {
        title: "Domino's – Giảm 35% Đơn Online",
        description: "Giảm 35% cho đơn hàng online từ 200.000đ. Miễn phí giao hàng.",
        originalPrice: new Prisma.Decimal(350000),
        salePrice: new Prisma.Decimal(227000),
  ...
  6: [
    {
      data: {
        title: "Paris Baguette – Giảm 20% Bánh Kem",
        description: "Giảm 20% cho tất cả bánh kem và bánh ga-lăng. Đặt trước 24h.",
        originalPrice: new Prisma.Decimal(350000),
        salePrice: new Prisma.Decimal(280000),
    ...
    {
      data: {
        title: "Bánh Mì Hoa Ma – Combo Bữa Sáng",
        description: "Combo 1 bánh mì thịt + 1 cà phê sữa. Chỉ áp dụng buổi sáng 6h-10h.",
        originalPrice: new Prisma.Decimal(65000),
        salePrice: new Prisma.Decimal(49000),
  ...
  7: [
    {
      data: {
        title: "California Fitness – 1 Tháng Miễn Phí",
        description: "Tặng 1 tháng tập gym miễn phí khi mua gói 3 tháng trở lên.",
        originalPrice: new Prisma.Decimal(1800000),
        salePrice: new Prisma.Decimal(1350000),
    ...
    {
      data: {
        title: "Fit24 – Giảm 25% Gói Yoga",
        description: "Giảm 25% cho gói Yoga 10 buổi. Bao gồm yoga, pilates và stretching.",
        originalPrice: new Prisma.Decimal(2000000),
        salePrice: new Prisma.Decimal(1500000),
  ...
  8: [
    {
      data: {
        title: "Spa Elite – Massage Toàn Thân 60p",
        description: "Massage toàn thân 60 phút bằng dầu thơm + trà miễn phí sau massage.",
        originalPrice: new Prisma.Decimal(450000),
        salePrice: new Prisma.Decimal(359000),
    ...
    {
      data: {
        title: "Massage & Wellness – Giảm 30% Gói Combo",
        description: "Giảm 30% gói combo spa 3 buổi: massage + facial + foot spa.",
        originalPrice: new Prisma.Decimal(1200000),
        salePrice: new Prisma.Decimal(840000),
  ...
  9: [
    {
      data: {
        title: "Game Net VN – 10 Giờ Chơi Miễn Phí",
        description: "Nhận 10 giờ chơi game PC miễn phí khi nạp thẻ từ 200.000đ.",
        originalPrice: new Prisma.Decimal(200000),
  ...
  10: [
    {
      data: {
        title: "Saigontourist – Tour Đà Lạt 3N2Đ",
        description: "Tour Đà Lạt 3 ngày 2 đêm, bao gồm khách sạn 3 sao + ăn sáng. Khởi hành cuối tuần.",
        originalPrice: new Prisma.Decimal(3500000),
        salePrice: new Prisma.Decimal(2790000),
    ...
    {
      data: {
        title: "Vietravel – Vé Máy Bay Giảm 15%",
        description: "Giảm 15% vé máy bay nội địa. Áp dụng cho hạng phổ thông.",
        originalPrice: new Prisma.Decimal(2500000),
        salePrice: new Prisma.Decimal(2125000),
  ...
  11: [
    {
      data: {
        title: "New World Hotel – 1 Đêm Executive Suite",
        description: "1 đêm tại Executive Suite, bao gồm buffet sáng cho 2 người + spa discount 20%.",
        originalPrice: new Prisma.Decimal(6500000),
        salePrice: new Prisma.Decimal(5200000),
    ...
    {
      data: {
        title: "Lotte Hotel – Weekend Escape Giảm 30%",
        description: "Giảm 30% cho đặt phòng cuối tuần (thứ 7, CN). Bao gồm late check-out 14h.",
        originalPrice: new Prisma.Decimal(4200000),
        salePrice: new Prisma.Decimal(2940000),
  ...
  12: [
    {
      data: {
        title: "Galaxy Cinema – 2 Vé + 2 Combo",
        description: "2 vé xem phim 2D + 2 bắp nước size lớn. Không áp dụng suất chiếu đặc biệt.",
        originalPrice: new Prisma.Decimal(350000),
        salePrice: new Prisma.Decimal(279000),
    ...
    {
      data: {
        title: "CGV – Thứ 4 Vé Chỉ 45.000đ",
        description: "Vé xem phim 2D chỉ 45.000đ vào thứ 4 hàng tuần. Áp dụng cho tất cả các rạp.",
        originalPrice: new Prisma.Decimal(90000),
        salePrice: new Prisma.Decimal(45000),
        imageUrl: "https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=800&h=600&fit=crop",
        expiryDays: 7,
        totalQuantity: 500,
        availableQuantity: 500,
      },
  ...
  13: [
    {
      data: {
        title: "Salon Hair Spa – Cắt tóc + Gội Đầu",
        description: "Combo cắt tóc + gội đầu + massage da đầu. Thợ lành nghề 5 năm kinh nghiệm.",
        originalPrice: new Prisma.Decimal(200000),
        salePrice: new Prisma.Decimal(149000),
    ...
    {
      data: {
        title: "L'Amour Beauty – Facial 60p Giảm 25%",
        description: "Gói facial cơ bản 60 phút + mask dưỡng. Giảm 25% cho khách hàng mới.",
        originalPrice: new Prisma.Decimal(350000),
        salePrice: new Prisma.Decimal(262000),
  ...
  14: [
    {
      data: {
        title: "Hồ Bơi Olympic – 10 Vé Giảm 20%",
        description: "Mua 10 vé vào hồ bơi Olympic, được giảm 20%. Vé có hiệu lực trong 30 ngày.",
        originalPrice: new Prisma.Decimal(300000),
        salePrice: new Prisma.Decimal(240000),
        imageUrl: "https://images.unsplash.com/photo-1575429198097-0414ec08e8cd?w=800&h=600&fit=crop",
        expiryDays: 30,
        totalQuantity: 50,
        availableQuantity: 50,
      },
  ...
  15: [
    {
      data: {
        title: "Pharmacity – Giảm 15% Vitamin",
        description: "Giảm 15% cho tất cả vitamin và thực phẩm chức năng. Áp dụng cho đơn từ 100.000đ.",
        originalPrice: new Prisma.Decimal(250000),
        salePrice: new Prisma.Decimal(212500),
    ...
    {
      data: {
        title: "Long Chau – Free Test Vitamin D",
        description: "Miễn phí xét nghiệm Vitamin D tại cửa hàng. Kết hợp giảm 20% gói bổ sung vitamin.",
        originalPrice: new Prisma.Decimal(300000),
        salePrice: new Prisma.Decimal(240000),
        imageUrl: "https://images.unsplash.com/photo-1576602976047-174e57a47881?w=800&h=600&fit=crop",
        expiryDays: 30,
        totalQuantity: 100,
        availableQuantity: 100,
      },
