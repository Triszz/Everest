...
function HeroContent() {
  return (
    <>
      ...
      >
        Trải nghiệm hàng ngàn voucher từ các thương hiệu hàng đầu Việt Nam. Từ ẩm thực tinh tế đến những chuyến du lịch
        xa hoa, chúng tôi mang giá trị tốt nhất đến tay bạn.
      </p>
